...
class test_packets (DnTest):
    ...
    def test_ackdata (self):
        ...
        ackdat = self.short (p, nsp.NspHdr, maxlen = 6)
        self.assertIsInstance (ackdat, nsp.AckData)
    ...
    def test_ackother (self):
        ...
        ackoth = self.short (p, nsp.NspHdr, maxlen = 6)
        self.assertIsInstance (ackoth, nsp.AckOther)
    ...
    def test_ackconn (self):
        p = b"\x24\x03\x00"
        ackconn = self.short (p, nsp.NspHdr)
        self.assertIsInstance (ackconn, nsp.AckConn)
    ...
    def test_data (self):
        ...
        dat = self.short (p, nsp.NspHdr, maxlen = 6)
        self.assertIsInstance (dat, nsp.DataSeg)
        ...
        dat = self.short (p0, nsp.NspHdr, maxlen = 6)
        self.assertIsInstance (dat, nsp.DataSeg)
        self.assertTrue (dat.bom)
        self.assertTrue (dat.eom)
        self.assertEqual (dat.dstaddr, 3)
        ...
        dat = self.short (p, nsp.NspHdr, maxlen = 8)
        self.assertIsInstance (dat, nsp.DataSeg)
        ...
        dat = self.short (p, nsp.NspHdr, maxlen = 10)
        self.assertIsInstance (dat, nsp.DataSeg)
        self.assertFalse (dat.bom)
        self.assertTrue (dat.eom)
        self.assertEqual (dat.dstaddr, 3)
    ...
    def test_intmsg (self):
        ...
        dat = self.short (p, nsp.NspHdr, maxlen = 6)
        self.assertIsInstance (dat, nsp.IntMsg)
        self.assertEqual (dat.dstaddr, 3)
        self.assertEqual (dat.srcaddr, 261)
        self.assertIsNone (dat.acknum)
        self.assertIsNone (dat.acknum2)
    ...
    def test_lsmsg (self):
        ...
        dat = self.short (p, nsp.NspHdr)
        self.assertIsInstance (dat, nsp.LinkSvcMsg)
        self.assertEqual (dat.dstaddr, 3)
        self.assertEqual (dat.srcaddr, 261)
        self.assertIsNone (dat.acknum)
        self.assertIsNone (dat.acknum2)
    ...
    def test_ci (self):
        ...
        ci = self.short (p, nsp.NspHdr, maxlen = 8)
        ...
        ci = self.short (pr, nsp.NspHdr, maxlen = 8)
        self.assertIsInstance (ci, nsp.ConnInit)
    ...
    def test_cc (self):
        ...
        cc = self.short (p, nsp.NspHdr, maxlen = 9)
    ...
    def test_di (self):
        ...
        di = self.short (p, nsp.NspHdr)
        self.assertIsInstance (di, nsp.DiscInit)
    ...
    def test_dc (self):
        ...
        dc = self.short (p, nsp.NspHdr)
        # It should be precisely DiscConf, not one of its subclasses
        # for the special reason codes listed below.
        self.assertEqual (type (dc), nsp.DiscConf)
        ...
        dc = self.short (p, nsp.NspHdr)
        self.assertEqual (type (dc), nsp.NoRes)
        self.assertEqual (dc.dstaddr, 11)
        self.assertEqual (dc.srcaddr, 3)
        ...
        dc = self.short (p, nsp.NspHdr)
        self.assertEqual (type (dc), nsp.DiscComp)
        self.assertEqual (dc.dstaddr, 11)
        self.assertEqual (dc.srcaddr, 3)
        ...
        dc = self.short (p, nsp.NspHdr)
        self.assertEqual (type (dc), nsp.NoLink)
        self.assertEqual (dc.dstaddr, 11)
        self.assertEqual (dc.srcaddr, 3)
