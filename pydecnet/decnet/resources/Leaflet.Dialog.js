// Slightly modified to refer to the button icons by local SVG file
// references rather than FontAwesome references.  The icons are from
// FontAware, see credit in mapper.py.
// Paul Koning, 9/16/2021
...
L.Control.Dialog = L.Control.extend({
  ...
  _initLayout: function(){
    ...
    var grabberIcon = L.DomUtil.create('img');
    grabberIcon.src = '/resources/images/arrows-alt-solid.svg';
    ...
    closeIcon.src = '/resources/images/times-solid.svg';
    ...
    var resizeIcon = L.DomUtil.create('img');
    resizeIcon.src = '/resources/images/expand-alt-solid.svg';
