                ...
                ( NICE, True,
                 ...
                 ( 1011, C1, "Polling substate", None,
                         { 1 : "Active",
                           ...
                           3 : "Dying",
                           4 : "Dead" }),
                 # RSTS/E (DECnet/E) specific:
                 ( 2110, C1, "Autorestart", None, ed_values ),
                 # RSX specific:
                 ( 2320, DU1, "Active ratio" ))
...
class LineReply (NiceReply):
    ...
    _layout = ( ( LineEntity, "entity" ),
                ( NICE, True,
                 ...
                 # RSTS/E (DECnet/E) specific:
                 ( 2100, C1, "Verification", None,
                         ( "Off", "Originate", "Answer" )),
                 # RSX specific:
                 ( 2300, AI, "Owner" ),
                 ( 2310, O2, "Controller CSR" ),
                 ( 2311, O2, "Unit CSR" ),
                 ( 2312, O2, "Vector" ),
                 ( 2313, DU1, "Priority" ),
                 ( 2321, DU1, "Dead polling ratio" ),
                 ( 2320, AI, "Location" ))
                 + line_counters)
